import { FaUserCheck,FaUserEdit,FaChartBar,FaUsers } from "react-icons/fa";
    ...
    <div className="mt-10 ">
      ...
      <div className="md:grid md:grid-cols-2 gap-2 my-auto  ">
          <div className="flex justify-center bg-gradient-to-r from-green-300 via-green-300 to-green-400 h-28 rounded mt-14">
            <p className="text-6xl bg-gradient-to-r from-green-500 to-green-400 px-5 py-7 my-auto rounded-md -mt-8 mr-10  text-white  hover:animate-bounce">
