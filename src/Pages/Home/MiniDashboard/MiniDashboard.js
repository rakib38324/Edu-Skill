...
const MiniDashboard = () => {
  return (
    <div className="mt-10 ">
      <p className="text-cyan-600 text-center font-bold text-xl">
        Start to Success
      </p>
      <p className="text-3xl font-bold text-cyan-800 text-center">
      ...
      <div className="md:grid md:grid-cols-2 mt-20 ">
        <div className="md:grid md:grid-cols-2 gap-2 my-auto  ">
          <div className="flex justify-center bg-gradient-to-r from-green-300 via-green-300 to-green-400 h-28 rounded">
        ...
        <div>
          <img className="w-2/3 mx-auto" src={minidash} alt="Mini Dashboard" />
        </div>
      </div>
    </div>
  );
